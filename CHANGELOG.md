...
* provider constructors reject SDK passthrough options; Gemini's open_timeout/read_timeout kwargs and config members are replaced by Riffer::Providers::Gemini::Client.
