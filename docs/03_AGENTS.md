...
See [Agent Orchestration](14_AGENT_ORCHESTRATION.md) for full details including dynamic resolution, context propagation, and runtime configuration.
...
| Delegate to other agents      | Subagents         | [Agent Orchestration](14_AGENT_ORCHESTRATION.md)                     |
