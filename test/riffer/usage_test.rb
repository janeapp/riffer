...
describe Riffer::Usage do
  describe "#initialize" do
    ...
    it "sets cache_creation_tokens when provided" do
      usage = Riffer::Usage.new(input_tokens: 100, output_tokens: 50, cache_creation_tokens: 25)
      expect(usage.cache_creation_tokens).must_equal 25
    end

    it "sets cache_read_tokens when provided" do
      usage = Riffer::Usage.new(input_tokens: 100, output_tokens: 50, cache_read_tokens: 10)
  ...
  describe "#total_tokens" do
    ...
    it "returns zero when both are zero" do
      usage = Riffer::Usage.new(input_tokens: 0, output_tokens: 0)
  ...
  describe "#+" do
    it "combines input_tokens" do
      ...
      usage2 = Riffer::Usage.new(input_tokens: 200, output_tokens: 75)
    ...
    it "combines cache_creation_tokens when both have values" do
      usage1 = Riffer::Usage.new(input_tokens: 100, output_tokens: 50, cache_creation_tokens: 10)
      usage2 = Riffer::Usage.new(input_tokens: 200, output_tokens: 75, cache_creation_tokens: 15)
      combined = usage1 + usage2
      expect(combined.cache_creation_tokens).must_equal 25
    end

    it "combines cache_read_tokens when both have values" do
      usage1 = Riffer::Usage.new(input_tokens: 100, output_tokens: 50, cache_read_tokens: 5)
      usage2 = Riffer::Usage.new(input_tokens: 200, output_tokens: 75, cache_read_tokens: 8)
      combined = usage1 + usage2
    ...
    it "returns a new Usage instance" do
      ...
      usage2 = Riffer::Usage.new(input_tokens: 200, output_tokens: 75)
      combined = usage1 + usage2
      expect(combined).must_be_instance_of Riffer::Usage
