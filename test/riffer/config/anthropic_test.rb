...
describe Riffer::Config::Anthropic do
  describe "#api_key" do
    it "initializes to nil" do
      expect(Riffer::Config::Anthropic.new.api_key).must_be_nil
    end

    it "accepts a string" do
      section = Riffer::Config::Anthropic.new
  ...
  describe "#client" do
    it "initializes to nil" do
      expect(Riffer::Config::Anthropic.new.client).must_be_nil
    end
