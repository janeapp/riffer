...
describe Riffer::Skills::FilesystemBackend do
  let(:fixtures_path) { File.expand_path("../../fixtures/skills", __dir__) }
  let(:extra_path) { File.expand_path("../../fixtures/skills_extra", __dir__) }
  ...
  describe "#list_skills" do
    it "returns frontmatter for all discovered skills" do
      ...
      assert_equal %w[code-review data-analysis], names
    end
    ...
    it "scans multiple paths" do
      ...
      assert_equal %w[code-review data-analysis summarize], names
    end
