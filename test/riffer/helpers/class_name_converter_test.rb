...
describe Riffer::Helpers::ClassNameConverter do
  let(:converter_class) { Riffer::Helpers::ClassNameConverter }

  describe ".convert" do
    it "converts simple class name to snake_case" do
      result = converter_class.convert("Agent")
    ...
    it "converts complex real-world example" do
      result = converter_class.convert("Riffer::Messages::Assistant")
