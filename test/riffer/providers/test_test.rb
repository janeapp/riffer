...
describe Riffer::Providers::Test do
  ...
  describe "#stub_response" do
    it "sets a stubbed response with content" do
      ...
      result = provider.generate_text(prompt: "Hi", model: "test-model")
  ...
  describe "#generate_text" do
    it "returns an Assistant message when no stubbed response" do
      result = provider.generate_text(prompt: "Hello", model: "test-model")
      expect(result).must_be_instance_of Riffer::Messages::Assistant
    end
    ...
    it "stores system and user messages in calls when both provided" do
      provider.generate_text(prompt: "Hello", system: "You are helpful", model: "test-model")
  ...
  describe "#stream_text" do
    it "returns an enumerator" do
      result = provider.stream_text(prompt: "Hello", model: "test-model")
