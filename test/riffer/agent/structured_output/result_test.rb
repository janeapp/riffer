...
describe Riffer::Agent::StructuredOutput::Result do
  describe "#success?" do
    it "returns true when no error" do
      result = Riffer::Agent::StructuredOutput::Result.new(object: {sentiment: "positive"})
  ...
  describe "#object" do
    it "returns the validated object" do
      result = Riffer::Agent::StructuredOutput::Result.new(object: {sentiment: "positive", score: 0.9})
  ...
  describe "#error" do
    it "returns the error message" do
      result = Riffer::Agent::StructuredOutput::Result.new(error: "parse failed")
