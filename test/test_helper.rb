...
VCR.configure do |config|
  ...
  config.filter_sensitive_data("<AWS_TEST_IMAGE_S3_URI>") { ENV.fetch("AWS_TEST_IMAGE_S3_URI", "s3://test-bucket/test-image.png") }
  config.filter_sensitive_data("<AWS_TEST_DOCUMENT_S3_URI>") { ENV.fetch("AWS_TEST_DOCUMENT_S3_URI", "s3://test-bucket/test-document.pdf") }
end
